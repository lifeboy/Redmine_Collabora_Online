...
- **Required**: Yes
- **Default**: `https://office.myserver.com`
...
While that are ways to alows this, the easiest way to use the same domain for both,  ie https://redmine.myserver.com and https://collarabora.myserver.com.
